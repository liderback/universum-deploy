...
CREATE TABLE `activities` (
  ...
  `objetive` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `evidence` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `indicators` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `slug` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dba` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dba2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `performance_levels` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
INSERT INTO `activities_century_skills` (`activities_id`, `century_skills_id`) VALUES (1, 1), (17, 1), (17, 2), (17, 3), (33, 1), (33, 2), (33, 3);
...
INSERT INTO `activities_thinking_skills` (`activities_id`, `thinking_skills_id`) VALUES (1, 1), (17, 2), (33, 2);

CREATE TABLE `avatars` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `slug` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `skin_tone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `customizes` json NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `avatars` (`id`, `slug`, `skin_tone`, `customizes`) VALUES
('4c66b4dc-aa52-11ee-a2a0-2cf05d8dbc0d', 'M', '#fff2cc', '{\"bot\": \"0\", \"top\": \"0\", \"hair\": \"none\", \"head\": \"0\", \"shoes\": \"0\"}'),
('aa6b71c6-aa52-11ee-a2a0-2cf05d8dbc0d', 'M', '#fff2cc', '{\"bot\": \"0\", \"top\": \"0\", \"hair\": \"none\", \"head\": \"0\", \"shoes\": \"0\"}');

CREATE TABLE `branches` (
  `id` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dane_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `cashes` (
  ...
  `snip` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `type_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `cashes` (`id`, `name`, `snip`, `type_id`) VALUES (1, 'Moneda Universum', 'universum_coin', 1);

CREATE TABLE `cashes_finances` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` int NOT NULL,
  `finance_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `cash_types` (`id`, `name`) VALUES (1, 'univ_coin'), (2, 'univ_badge');
...
INSERT INTO `categories` (`id`, `name`) VALUES (1, 'Educational'), (2, 'Personal'), (3, 'Reward');
...
('284661f6-45fd-467d-8478-0df17f6f2294'),
('7bd323ec-58df-436d-bcfc-388c3a467ae3'),
('c2cc0cda-35ee-48b8-a02c-8a041adaded6'),
('d557ce0f-2cfc-4e19-b4f4-b012bd839b6e');
...
CREATE TABLE `gameplays` (
  ...
  `enrolment_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE `gameplay_learning_results` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `result` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `performance_level` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `gameplay_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `activity_id` int DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `imgs` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `hashable` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

CREATE TABLE `imgs_users` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `img_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `institutions` (
  `id` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dane_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `inventories` (`id`) VALUES ('16121ebd-e66e-4bb9-9bd3-a5405c94d434'), ('2665601f-afbf-47ff-89c0-8a73c0721488'), ('cf81b233-992b-479a-8a6c-7a4d91ed892d'), ('dd1b2c83-eb80-4834-9f62-1f3c0db16a17');
...
CREATE TABLE `licenses` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `serial` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `owner` int NOT NULL,
  `expired_date` date NOT NULL,
  `tumlab_name` varchar(155) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `profiles` (
  ...
  `birth` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
('2e67087e-b0e2-4cd8-b1d5-21d1c6b48f84', 'CES', 'Teacher', 'M', '1997-08-20T00:00:00.000Z', 26, 'NO APLICA'),
('afbdcba2-fdb2-4fb0-a31f-dad1dc11a815', 'CES', 'Student', 'M', '2006-09-13T00:00:00.000Z', 17, 'NO APLICA'),
('b80e6370-e103-41d5-9ea0-8300e73d8ad8', 'CES', 'Teacher', 'M', '1999-09-13T00:00:00.000Z', 24, 'NO APLICA'),
('e358dd56-1d59-4b83-be01-036eec8e1cb6', 'CES', 'Student', 'M', '2004-09-13T00:00:00.000Z', 19, 'NO APLICA');

CREATE TABLE `roles` (
  `id` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `display` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `school_years` (`id`, `name`) VALUES (1, 2023), (2, 2024), (3, 2025);

CREATE TABLE `subjects` (
  `id` int NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `snip` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO `subjects` (`id`, `name`, `snip`) VALUES (1, 'Ethics', 'ethics'), (8, 'Natural Sciences', 'natural'), (13, 'Conflict Resolution', 'conflict_management');
...
(17, 'CES Default Town', '400', 1);

CREATE TABLE `transactions` (
  `id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `transaction_id` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `amount` int NOT NULL,
...
CREATE TABLE `users` (
  `id` int NOT NULL,
  `keycloak_sub_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `username` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `active` tinyint NOT NULL DEFAULT '0',
  `activation_token` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `reset_password_token` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `created_on` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `profile_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `enrolment_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `inventory_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `finance_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `avatar_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(36492, '2b25b867-8a41-4a41-abdc-f108bbc8b86c', 'cesuser001', 'cesuser001@localhost.com', '$2a$10$xqBFidMJMqm8nT8E/o5kV.5u85fGf.ZRdI5JTwwEk8pabQAJfUPsq', 1, NULL, NULL, 0, 0, 0, 0, '2023-12-12 11:34:52.412585', 'e358dd56-1d59-4b83-be01-036eec8e1cb6', '3611f43a-8cd7-456d-833a-a8295a2f6acc', '2665601f-afbf-47ff-89c0-8a73c0721488', 'c2cc0cda-35ee-48b8-a02c-8a041adaded6', '4c66b4dc-aa52-11ee-a2a0-2cf05d8dbc0d', 7),
(121621, '9a1e4819-a72d-4216-93d8-c31204473951', 'cesuser002', 'cesuser002@localhost.com', '$2a$10$xqBFidMJMqm8nT8E/o5kV.5u85fGf.ZRdI5JTwwEk8pabQAJfUPsq', 1, NULL, NULL, 0, 0, 0, 0, '2023-12-12 11:34:52.416789', 'afbdcba2-fdb2-4fb0-a31f-dad1dc11a815', 'd4a67b86-4fd6-4683-b8e6-27a887641bc5', '16121ebd-e66e-4bb9-9bd3-a5405c94d434', 'd557ce0f-2cfc-4e19-b4f4-b012bd839b6e', 'aa6b71c6-aa52-11ee-a2a0-2cf05d8dbc0d', 7),
...
(1000000, '7968fcdc-17f6-4747-8ad7-db323c6a8868', 'cesteacher001', 'juanogr8@gmail.com', '$2a$10$xqBFidMJMqm8nT8E/o5kV.5u85fGf.ZRdI5JTwwEk8pabQAJfUPsq', 1, NULL, NULL, 0, 0, 0, 0, '2023-12-12 11:35:28.662940', 'b80e6370-e103-41d5-9ea0-8300e73d8ad8', '3c0f6ea4-b148-4f81-9b4f-1a849a3042e6', 'dd1b2c83-eb80-4834-9f62-1f3c0db16a17', '284661f6-45fd-467d-8478-0df17f6f2294', NULL, 8),
(1000001, 'ec323dd5-ed78-483d-b3d9-f7bb68b5907e', 'cesteacher002', 'marucha_209@hotmail.com', '$2a$10$xqBFidMJMqm8nT8E/o5kV.5u85fGf.ZRdI5JTwwEk8pabQAJfUPsq', 1, NULL, NULL, 0, 0, 0, 0, '2023-12-12 11:35:28.664447', '2e67087e-b0e2-4cd8-b1d5-21d1c6b48f84', '787ac8a9-58de-4e21-9de8-539a02956073', 'cf81b233-992b-479a-8a6c-7a4d91ed892d', '7bd323ec-58df-436d-bcfc-388c3a467ae3', NULL, 8);
